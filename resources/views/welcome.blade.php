...
@section('content')
    <div class="container">
        ...
        <p class="mt-3 text-center">Al concurso para el otorgamiento de las siguientes  plazas vacantes de tipo No Académico, de la modalidad de  contratación por tiempo determinado.</p>
        ...
        @endforeach
        @foreach ($categories as $category)
            <h5 class="text-primary mt-5">Vacantes de <a class="text-secondary">{{ $category->name }}</a></h5>
            <div class="row mt-3">
